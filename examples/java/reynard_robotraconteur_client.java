...
public class reynard_robotraconteur_client {
    public static void main(String[] args) {
        ...
        try
        {
            ...
            RobotRaconteurNode.s().registerServiceType(new experimental.reynard_the_robot.experimental__reynard_the_robotFactory());

            // Connect to the Reynard service using a URL
            experimental.reynard_the_robot.Reynard c = (experimental.reynard_the_robot.Reynard)RobotRaconteurNode.s().connectService("rr+tcp://localhost:29200?service=reynard");
